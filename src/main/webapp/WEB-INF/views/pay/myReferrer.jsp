							...
							<div class="content2">
							   <h2>${ userName }님의 수신참조함</h2>
							    ...
							    <div id="cen_bottom_pagging">
					               	...
					               	<li class="page-item ${ pi.currentPage == 1 ? 'disabled' : '' }"><a class="page-link" href="${ contextPath }/pay/myReferrer.page?page=${pi.currentPage-1}">◁</a></li>
					      
										      <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
										       	<li class="page-item ${ pi.currentPage == p ? 'disabled active' : '' }"><a class="page-link" href="${ contextPath }/pay/myReferrer.page?page=${p}">${ p }</a></li>
										      </c:forEach>
					      
										      <li class="page-item ${ pi.currentPage == pi.maxPage ? 'disabled' : '' }"><a class="page-link" href="${ contextPath }/pay/myReferrer.page?page=${pi.currentPage+1}">▷</a></li>
									   		</c:if>
									   	</ul>
					          </div>
				        	</div>
